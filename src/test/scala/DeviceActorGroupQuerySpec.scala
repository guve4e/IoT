...
//    ))
//
//    device1.expectMsg(DeviceActor.ReadValues(requestId = 0))
//    device2.expectMsg(DeviceActor.ReadValues(requestId = 0))
//
//    queryActor.tell(DeviceActor.ValuesRead(requestId = 0, Some(1.0)), device1.ref)
//    queryActor.tell(DeviceActor.ValuesRead(requestId = 0, Some(2.0)), device2.ref)
//
//    requester.expectMsg(DeviceGroup.RespondAllValues(
//      requestId = 1,
//      temperatures = Map(
//        "device1" -> DeviceGroup.Values(1.0),
//        "device2" -> DeviceGroup.Values(2.0)
//      )
//    ))
//  }
//
...
//    device2.expectMsg(DeviceActor.ReadValues(requestId = 0))
//
//    queryActor.tell(DeviceActor.ValuesRead(requestId = 0, None), device1.ref)
//    queryActor.tell(DeviceActor.ValuesRead(requestId = 0, Some(2.0)), device2.ref)
//
//    requester.expectMsg(DeviceGroup.RespondAllValues(
//      requestId = 1,
...
//    tempSensor.tell(DeviceActor.SendCommand(12 , 73.45), probe.ref)
//    probe.expectMsg(DeviceActor.CommandSent(12))
//
//    pressureSensor.tell(DeviceManager.RegisterDevice("sensors", "pressure sensor"), probe.ref)
//    probe.expectMsg(DeviceManager.DeviceRegistered)
//    pressureSensor.tell(DeviceActor.SendCommand(222 , 12.45), probe.ref)
//    probe.expectMsg(DeviceActor.CommandSent(222))
//
//    officeSwitch.tell(DeviceManager.RegisterDevice("switches", "office_switch"), probe.ref)
//    officeSwitch.tell(DeviceActor.SendCommand(222 , 12.45), probe.ref)
//
